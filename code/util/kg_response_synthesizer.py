...
from util.prompt_helper import KGPromptHelper
...
class Refine(BaseSynthesizer):
    ...
    def __init__(
        ...
        prompt_helper: Optional[KGPromptHelper] = None,
...
def get_response_synthesizer(
    ...
    prompt_helper = (
        ...
        or KGPromptHelper.from_llm_metadata(
            llm.metadata,
        )
    )
...
class CompactAndRefine(Refine):
    ...
    def get_response(
        ...
        **response_kwargs: Any,
        ...
        # print(f'input text chunks: {text_chunks}')
    ...
    def _make_compact_text_chunks(
        ...
        res =  self._prompt_helper.repack(max_prompt, text_chunks)
        if len(res)>1:
            print(f'prompt repack oversize: {len(res)}')
        return res
